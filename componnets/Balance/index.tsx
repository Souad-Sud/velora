...
const Balance = () => {
  return (
    <section className="w-full px-7 py-10 text-center">
      ...
      <div className="mx-auto mt-10 grid w-full max-w-375 grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {balanceItem.map((item, index) => (
          <div
            className="group w-full cursor-pointer flex flex-col items-center justify-center"
            key={index}
          >
